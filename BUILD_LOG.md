...
- **Ruling N（2026-08-24，仅授权、尚未执行）**：基于 `c9752f6` 与 Ruling M `PASS 0/0/0` 完成 read-only preflight：tracked/index clean，仅保留冻结 manifest/source；五份证据哈希精确为 `6e71d9...4682`、`eca7fd...f19e2`、`869172...41de`、`46c5d7...4e98`、`afc00f...2abf`，marker 不存在；legacy 两行 raw SHA 与 production allowlist 精确相等；canary 仍为一行 canonical g051，SHA-256 `e21591fc33f27630ebd52dcd5fd8afb0b03f8aa9b12c5a1f487475dd416c936c`；CPA 静态绑定仍为 Text/Vision `grok4.6` 与 Image `grok-imagine-image-quality`，启用且 key present。只授权冻结命令执行一次第四 g051 canary，以取得诚实的 v2 `schema_stage` 诊断或完整 ready receipt；运行时模型继续 fail closed。不得增加参数、retry、g052–g120、bulk、manual promote、Task 5/UI 或 S16B 完成。一次进程退出后必须停止并交 fresh reviewer；本条不包含实际 CPA 调用。
